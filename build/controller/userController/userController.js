...
var userController = /*#__PURE__*/_createClass(function userController() {
  ...
  // getAll User
  _defineProperty(this, "getAllUSer", /*#__PURE__*/function () {
  ...
  // delete
  _defineProperty(this, "deleteUser", function (req, res) {});
  // get Singal User
  _defineProperty(this, "getSingleUser", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
      var cacheKey, cachedData, data;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            cacheKey = "User:".concat(req.params.id);
            _context3.prev = 1;
            _context3.next = 4;
            return _redisConfig["default"].get(cacheKey);
          case 4:
          ...
          case 9:
            ...
            return _context3.abrupt("return", res.status(404).json({
              message: "Data not found with ".concat(req.params.id)
            }));
          case 12:
            _redisConfig["default"].set(cacheKey, JSON.stringify(data), {
              EX: 60
            });
  ...
  // for the update user
  _defineProperty(this, "updateUser", function (req, res) {});
});
